...
Issue:
> Temporary akumulasi sudah ada, tapi proses penyimpanan datanya langsung dipisah aja.
- Buat def untuk webhook2, agar bisa mengirim data ke table 2
- Ketika button cetak struk ditekan, langsung mengirim data total ke table lainnya (scantotal via command webhook2)
- Data yang diinput di table scanfinal
...
'''
ini dicopas ======================
diambil data result final, transaction_code, transaction_date, amount
'''
